...
const DICT = {
  uk: {
    ...
    "buttonDesign.sizeSm": "Маленька",
    "buttonDesign.sizeMd": "Середня",
    "buttonDesign.sizeLg": "Велика",
    ...
    "buttonDesign.modalWidth": "Ширина вікна примірки",
    "buttonDesign.modalWidthSm": "Компактна",
    "buttonDesign.modalWidthMd": "Стандартна",
    "buttonDesign.modalWidthLg": "Широка",
  ...
  en: {
    ...
    "buttonDesign.sizeSm": "Small",
    "buttonDesign.sizeMd": "Medium",
    "buttonDesign.sizeLg": "Large",
    ...
    "buttonDesign.modalWidth": "Try-on window width",
    "buttonDesign.modalWidthSm": "Compact",
    "buttonDesign.modalWidthMd": "Standard",
    "buttonDesign.modalWidthLg": "Wide",
