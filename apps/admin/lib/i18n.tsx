...
const DICT = {
  uk: {
    ...
    "tenantDetail.trialOption": "Тестовий режим (5 примірок)",
    "tenantDetail.grantTrial": "Активувати тестовий період (+5)",
    "tenantDetail.trialActive": "Тестовий період активовано",
    "tenantDetail.trialErrorActive": "У клієнта вже є активний тестовий баланс.",
    "tenantDetail.trialErrorHasPlan": "Клієнту вже призначено тариф — тестовий режим лише для тих, у кого немає тарифу.",
  ...
  en: {
    ...
    "tenantDetail.trialOption": "Trial mode (5 try-ons)",
    "tenantDetail.grantTrial": "Activate trial (+5)",
    "tenantDetail.trialActive": "Trial period active",
    "tenantDetail.trialErrorActive": "This tenant already has an active trial balance.",
    "tenantDetail.trialErrorHasPlan": "A plan is already assigned — trial mode is only for tenants with no plan.",
