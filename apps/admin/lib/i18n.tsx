...
const DICT = {
  uk: {
    ...
    "account.statusTitle": "Статус акаунта",
    "account.statusDesc": "Неактивний акаунт не зможе створювати нові примірки — кнопка на сайті клієнта перестане працювати. Дані нікуди не зникають.",
    "account.statusActive": "Активний",
    "account.statusSuspended": "Неактивний",
    "account.dangerTitle": "Небезпечна зона",
    "account.deleteTryOnsTitle": "Видалити всі примірки",
    "account.deleteTryOnsDesc": "Видаляє всю історію примірок цього клієнта (разом з фото) назавжди. Тариф, доступи команди та налаштування кнопки залишаються без змін.",
    "account.deleteTryOnsButton": "Видалити всі примірки",
    "account.deleteTryOnsConfirm": "Видалити всі примірки клієнта «{name}»? Це незворотньо.",
    "account.deleteAccountTitle": "Видалити акаунт",
    "account.deleteAccountDesc": "Видаляє акаунт клієнта повністю: магазин, команду, тариф, всю історію примірок і фото. Незворотньо.",
    "account.deleteAccountButton": "Видалити акаунт назавжди",
    "account.deleteAccountConfirmLabel": "Щоб підтвердити, введіть назву компанії:",
    ...
    "buttonDesign.modalLayout": "Вигляд вікна примірки",
    "buttonDesign.modalLayoutSplit": "На весь екран",
    "buttonDesign.modalLayoutSplitDesc": "Фото і товар займають увесь екран",
    "buttonDesign.modalLayoutCompact": "Невелике спливаюче вікно",
    "buttonDesign.modalLayoutCompactDesc": "Компактна картка поверх затемненої сторінки товару",
    ...
    "buttonDesign.modalHeadingPlaceholder": "Завантаж своє фото",
    "buttonDesign.modalSubheadingPlaceholder": "Чітке фото анфас з хорошим освітленням дає найкращий результат.",

    "buttonDesign.tabButton": "Кнопка",
    "buttonDesign.tabModal": "Вікно примірки",
    "buttonDesign.tabCard": "Кнопка на мінікартці",
    "buttonDesign.previewModalBrand": "Віртуальна примірка",
    "buttonDesign.previewModalCta": "Приміряти",
    "buttonDesign.previewModalBadge": "Приклад фото",
    "buttonDesign.previewProductName": "Назва товару",
    "buttonDesign.previewModalAddToCart": "Додати до кошика",
    "buttonDesign.cardDesc": "Невелика кнопка «Приміряти» прямо на мініатюрі товару в каталозі клієнта — не тільки на сторінці самого товару. Використовує ті самі колір і текст, що й кнопка вище.",
    "buttonDesign.cardEnable": "Показувати кнопку на картках товарів у каталозі",
    "buttonDesign.cardVariant": "Вигляд кнопки",
    "buttonDesign.cardVariantCorner": "Кутовий значок",
    "buttonDesign.cardVariantCornerDesc": "Маленьке коло в кутку фото, розкривається в підпис при наведенні",
    "buttonDesign.cardVariantDrawer": "Нижня шторка",
    "buttonDesign.cardVariantDrawerDesc": "Смуга кольору кнопки виїжджає знизу фото",
    "buttonDesign.cardVariantScrim": "Затемнення",
    "buttonDesign.cardVariantScrimDesc": "Фото злегка темніє, по центру з'являється кнопка",
    "buttonDesign.cardNote": "На мобільних кнопка завжди видима (без наведення) — для кутового значка перша картка каталогу один раз тихо підморгне, щоб пояснити її призначення.",
    "buttonDesign.cardPreviewOff": "Зараз вимкнено — увімкніть перемикач ліворуч, щоб побачити прев'ю.",
    "buttonDesign.cardPreviewProduct": "Назва товару",
    "buttonDesign.cardPreviewHint": "Наведіть курсор на фото товару, щоб побачити, як кнопка з'являється (на десктопі). На мобільних вона видима одразу.",
  ...
  en: {
    ...
    "account.statusTitle": "Account status",
    "account.statusDesc": "A suspended account can't create new try-ons — the button on the client's site stops working. Nothing is deleted.",
    "account.statusActive": "Active",
    "account.statusSuspended": "Suspended",
    "account.dangerTitle": "Danger zone",
    "account.deleteTryOnsTitle": "Delete all try-ons",
    "account.deleteTryOnsDesc": "Permanently deletes this client's entire try-on history (photos included). Their plan, team access, and button design stay untouched.",
    "account.deleteTryOnsButton": "Delete all try-ons",
    "account.deleteTryOnsConfirm": "Delete every try-on for \"{name}\"? This can't be undone.",
    "account.deleteAccountTitle": "Delete account",
    "account.deleteAccountDesc": "Permanently deletes this client's entire account: store, team, plan, and every try-on and photo. This can't be undone.",
    "account.deleteAccountButton": "Delete account permanently",
    "account.deleteAccountConfirmLabel": "Type the company name to confirm:",
    ...
    "buttonDesign.modalLayout": "Try-on window style",
    "buttonDesign.modalLayoutSplit": "Full screen",
    "buttonDesign.modalLayoutSplitDesc": "Photo and product fill the whole screen",
    "buttonDesign.modalLayoutCompact": "Small popup",
    "buttonDesign.modalLayoutCompactDesc": "A compact card over the dimmed product page",
    ...
    "buttonDesign.modalHeadingPlaceholder": "Upload your photo",
    "buttonDesign.modalSubheadingPlaceholder": "A clear front-facing photo with good lighting works best.",

    "buttonDesign.tabButton": "Button",
    "buttonDesign.tabModal": "Try-on window",
    "buttonDesign.tabCard": "Mini-card button",
    "buttonDesign.previewModalBrand": "Virtual try-on",
    "buttonDesign.previewModalCta": "Try on",
    "buttonDesign.previewModalBadge": "Example photo",
    "buttonDesign.previewProductName": "Product name",
    "buttonDesign.previewModalAddToCart": "Add to cart",
    "buttonDesign.cardDesc": "A small \"Try on\" button right on a product's thumbnail in the client's catalog — not just on the product page itself. Uses the same color and label as the button above.",
    "buttonDesign.cardEnable": "Show a try-on button on catalog product cards",
    "buttonDesign.cardVariant": "Button style",
    "buttonDesign.cardVariantCorner": "Corner mark",
    "buttonDesign.cardVariantCornerDesc": "A small circle in the photo's corner, expands into a label on hover",
    "buttonDesign.cardVariantDrawer": "Bottom drawer",
    "buttonDesign.cardVariantDrawerDesc": "A strip in the button's color slides up from the bottom of the photo",
    "buttonDesign.cardVariantScrim": "Dim overlay",
    "buttonDesign.cardVariantScrimDesc": "The photo dims slightly with a button appearing in the center",
    "buttonDesign.cardNote": "On mobile the button is always visible (no hover) — for the corner mark, the catalog's first card pulses once to explain what it does.",
    "buttonDesign.cardPreviewOff": "Currently off — turn on the switch on the left to see a preview.",
    "buttonDesign.cardPreviewProduct": "Product name",
    "buttonDesign.cardPreviewHint": "Hover over the product photo to see the button appear (desktop). On mobile it's visible right away.",
