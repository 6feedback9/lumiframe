...
function FeedbackContent() {
  ...
  useEffect(() => {
    apiFetch<{ items: FeedbackRow[] }>(`/api/v1/admin/tryons?limit=100&feedback=${filter}`)
  ...
  return (
    <>
      ...
      <p style={{ fontSize: 13, color: "var(--mist)", marginBottom: 20, maxWidth: 620 }}>{t("feedback.desc")}</p>
      ...
      <div className="panel">
        <table>
          <thead>
            <tr>
              <th>{t("feedback.tenant")}</th>
              <th>{t("feedback.store")}</th>
